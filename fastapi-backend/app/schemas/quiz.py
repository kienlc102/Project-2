...
class QuizQuestion(BaseModel):
    # Accept 'question_text' (from DB SQLAlchemy attr) OR 'question' (from AI/frontend JSON)
    question: str = Field(..., validation_alias=AliasChoices('question_text', 'question'), description="The question text")
    ...
    explanation: Optional[str] = Field(default="", description="Explanation for the correct answer")
