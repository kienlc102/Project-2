          ...
          <div className="flex-1 space-y-4">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              ...
              {loading ? (
                ...
                <div className="flex items-center gap-3 m-5 p-4 bg-rose-50 border border-rose-200 rounded-xl text-rose-600 text-sm">
                ...
                <div className="py-16 text-center text-slate-500">
                  ...
                  <p className="text-sm mt-1 text-slate-400">Hãy là người đầu tiên đăng bài!</p>
                </div>
              ) : (
                    ...
                    <li key={post.id} className="group hover:bg-cyan-50/30 transition-colors">
                      <Link href={`/forum/${post.id}`} className="flex gap-4 px-5 py-4">
                        ...
                        <div className={`shrink-0 flex flex-col items-center justify-center w-12 h-12 rounded-xl border font-bold text-sm ${
                          post.score > 0 ? 'bg-cyan-50 border-cyan-200 text-cyan-700' :
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-semibold text-slate-900 group-hover:text-cyan-700 transition-colors line-clamp-1 text-base leading-tight">
                            {post.title}
                          </h3>
                        ...
                        {/* Comment count */}
                        <div className="shrink-0 flex flex-col items-center justify-center text-xs text-slate-500">
            ...
            {pagination && pagination.totalPages > 1 && (
              <div className="flex items-center justify-center gap-2 pt-2">
                <button
                  ...
                  disabled={page <= 1}
                  className="px-4 py-2 bg-white border border-slate-200 rounded-xl text-sm font-semibold text-slate-600 hover:bg-slate-50 disabled:opacity-40 disabled:cursor-not-allowed transition shadow-sm"
                >
                  ← Trước
                </button>
