    ...
    <div className="min-h-screen bg-slate-50 py-10 px-4 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-3xl space-y-6 relative z-10">
        ...
        {loading ? (
          ...
          <div className="flex items-center gap-3 p-5 bg-rose-50 border border-rose-200 rounded-2xl text-rose-600">
          ...
          <>
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex flex-wrap gap-4 mt-4">
                    ...
                    <div className="flex items-center gap-2 text-sm text-slate-600 bg-slate-50 border border-slate-200 px-3 py-1.5 rounded-xl">
                      ...
                      <span className="font-semibold text-slate-800">{stats?.post_count ?? 0}</span>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm overflow-hidden">
              <div className="flex items-center gap-2 px-5 py-4 border-b border-slate-100 bg-slate-50/60">
                ...
                <span className="ml-auto text-xs text-slate-400">{posts.length} bài viết</span>
              </div>
                          ...
                          <div className="flex flex-wrap items-center gap-2 mt-2.5">
                            {post.tags.slice(0, 4).map(tag => (
                              <Link
                                ...
                                className="text-xs px-2 py-0.5 rounded-full border bg-cyan-50 border-cyan-200 text-cyan-700 hover:bg-cyan-100 font-medium transition"
                              >
                                #{tag}
                              </Link>
                            ))}
