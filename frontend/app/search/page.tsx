    ...
    <div className="max-w-7xl mx-auto px-4 py-12 relative z-10">
      ...
      {loading ? (
        ...
        <div className="text-center py-24 bg-white backdrop-blur-xl rounded-3xl border border-slate-200 shadow-2xl relative overflow-hidden">
          ...
          <h3 className="text-2xl font-bold text-slate-900 mb-3 relative z-10">Không tìm thấy kết quả nào</h3>
        ...
        <div className="space-y-12">
          ...
          {results.length > 0 && (
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                <div className="p-2 bg-indigo-100 rounded-lg border border-indigo-500/30">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {results.map((doc) => (
                  <div
                    ...
                    className="bg-white p-6 rounded-3xl border border-slate-200 hover:shadow-[0_10px_30px_rgba(99,102,241,0.15)] hover:border-indigo-500/30 transition-all duration-300 group flex flex-col cursor-pointer relative overflow-hidden shadow-inner"
                  >
          ...
          {subjects.length > 0 && (
            <div>
              <h2 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-3">
                <div className="p-2 bg-emerald-500/20 rounded-lg border border-emerald-300">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {subjects.map((subject) => (
                  <div
                    ...
                    className="bg-white p-6 rounded-3xl border border-slate-200 hover:shadow-[0_10px_30px_rgba(16,185,129,0.15)] hover:border-emerald-300 transition-all group cursor-pointer relative overflow-hidden shadow-inner"
                  >
                    ...
                    <div className="flex items-start gap-4 relative z-10">
                      <div className="p-3 bg-white rounded-2xl border border-slate-200 group-hover:scale-110 transition-transform flex-shrink-0 shadow-md">
                        <BookOpen className="w-6 h-6 text-emerald-600" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-bold text-emerald-600 uppercase tracking-widest mb-1.5">{subject.subject_code}</p>
                        <h3 className="text-lg font-bold text-slate-900 line-clamp-2 group-hover:text-emerald-700 transition-colors">
