              ...
              <div className="space-y-3">
                ...
                {activeTab !== 'quiz' && activeTab !== 'flashcard' && filteredDocs.map(doc => (
                  <div
                    ...
                    className={`group flex items-center gap-4 bg-slate-50 rounded-2xl p-4 border transition-all cursor-pointer relative overflow-hidden ${selectedDocs.includes(doc.id)
                  ...
                  >
                    <div className="flex-shrink-0 ml-2">
                      <div className={`w-5 h-5 rounded border flex items-center justify-center transition-colors ${selectedDocs.includes(doc.id) ? 'bg-indigo-600 border-indigo-600' : 'border-slate-500 bg-white'
                        }`}>
                    ...
                    <div className="flex-shrink-0 mr-2">
                      <Link
                        ...
                        className="px-4 py-2 bg-slate-100 text-slate-900 hover:bg-indigo-500 hover:text-white rounded-lg text-sm font-bold transition-all shadow-md whitespace-nowrap"
                      >
                        Xem chi tiết
                      </Link>
                    </div>
          ...
          <div className="lg:col-span-4">
            <div className="sticky top-24 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-2xl border border-slate-200 relative overflow-hidden group">
                <div className={`absolute top-0 right-0 w-32 h-32 rounded-full blur-[40px] -mr-10 -mt-10 pointer-events-none transition-colors ${activeGeneratorTab === 'quiz' ? 'bg-fuchsia-50 group-hover:bg-fuchsia-100' : 'bg-emerald-50 group-hover:bg-emerald-500/20'
                  }`}></div>
                ...
                <div className="flex bg-slate-50 rounded-xl p-1 mb-8 relative z-10 border border-slate-100">
                  <button
                    ...
                    className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${activeGeneratorTab === 'quiz'
                  ...
                  <button
                    ...
                    className={`flex-1 py-2.5 text-sm font-bold rounded-lg transition-all ${activeGeneratorTab === 'flashcard'
                ...
                <div className="flex items-center gap-4 mb-6 relative z-10">
                  <div className={`p-3 rounded-xl border shadow-inner ${activeGeneratorTab === 'quiz'
                      ? 'bg-fuchsia-100 border-fuchsia-300'
                      : 'bg-emerald-500/20 border-emerald-300'
                    }`}>
                    <Sparkles className={`w-6 h-6 ${activeGeneratorTab === 'quiz' ? 'text-fuchsia-600' : 'text-emerald-600'
                      }`} />
                  </div>
                ...
                <div className="space-y-5 mb-8 relative z-10">
                  <div>
                    ...
                    <div className="text-sm bg-slate-50 p-4 rounded-xl border border-slate-100 shadow-inner">
                      {selectedDocs.length === 0 ? (
                        ...
                        <div className={`flex items-center gap-3 font-bold justify-center ${activeGeneratorTab === 'quiz' ? 'text-fuchsia-600' : 'text-emerald-600'
                          }`}>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className={`w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-sm text-slate-900 focus:ring-2 focus:border-transparent outline-none transition-all h-24 resize-none shadow-inner placeholder-slate-600 custom-scrollbar ${activeGeneratorTab === 'quiz' ? 'focus:ring-fuchsia-500' : 'focus:ring-emerald-500'
                        }`}
                    />
                  </div>
                </div>
