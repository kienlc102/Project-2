    ...
    <div className="min-h-screen bg-slate-50 py-10 px-4 relative overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl space-y-8 relative z-10">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div>
            <p className="text-sm uppercase tracking-[0.24em] text-indigo-600 font-semibold">Môn học</p>
        ...
        <section className="rounded-3xl border border-slate-200 bg-white backdrop-blur-xl p-8 shadow-2xl transition-all hover:bg-slate-50">
          <div className="flex items-center justify-between gap-4 mb-8 border-b border-slate-200 pb-5">
            <div>
              ...
              <p className="mt-1 text-sm text-slate-600">Những môn học có nhiều tài liệu và bài tập.</p>
            </div>
                ...
                >
                  ...
                  <div className="flex items-start gap-4 relative z-10">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <h3 className="mt-1 text-lg font-bold text-slate-900 line-clamp-2 leading-tight group-hover:text-indigo-700 transition-colors">
                        {subject.subject_name}
                      </h3>
                    </div>
                  </div>
                  <div className="mt-6 pt-4 border-t border-slate-200 flex items-center justify-between text-sm text-slate-600 relative z-10">
                    <div className="flex items-center gap-1.5 text-slate-600">
                      <GraduationCap className="w-4 h-4 text-emerald-600" />
                      <span className="truncate max-w-[150px]">{subject.university_name}</span>
                    </div>
                    <span className="rounded-lg bg-indigo-50 border border-indigo-200 px-3 py-1 text-indigo-700 font-mono shadow-md">
