...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen text-slate-200 font-sans selection:bg-indigo-500/30 overflow-hidden relative">
      {/* Background Orbs */}
      ...
      <section className="relative pt-16 pb-20 px-6 max-w-7xl mx-auto text-center z-10">
        <div className="inline-flex items-center gap-2 bg-indigo-500/10 border border-indigo-500/20 text-indigo-300 px-4 py-2 rounded-full text-sm font-semibold mb-8 backdrop-blur-md">
        ...
        <form onSubmit={handleSearch} className="max-w-3xl mx-auto mb-14 relative group">
          ...
          <div className="relative flex items-center w-full h-16 rounded-2xl bg-[#131A2B] border border-white/10 overflow-hidden transition-all shadow-2xl">
            <div className="pl-6 pr-4 text-slate-500">
              <Search className="h-6 w-6" />
            </div>
            <input
              className="peer h-full w-full outline-none text-lg text-white bg-transparent placeholder-slate-500"
              type="text"
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            <Link
              key={idx}
              href={item.href}
              className={`group relative bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-8 transition-all duration-500 hover:-translate-y-2 hover:bg-white/[0.08] shadow-lg ${item.glow}`}
            >
              ...
              <div className="flex items-center gap-2 text-white font-medium text-sm opacity-70 group-hover:opacity-100 group-hover:gap-3 transition-all">
                Khám phá ngay
      ...
      {/* Why Choose Us */}
      <section className="border-t border-white/5 bg-[#080B14] relative z-10 overflow-hidden">
        {/* Subtle grid background */}
        <div className="absolute inset-0 bg-[url('https://grainy-gradients.vercel.app/noise.svg')] opacity-20 mix-blend-overlay"></div>
        <div className="max-w-7xl mx-auto px-6 py-24 relative z-10">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Hệ sinh thái học tập <span className="text-indigo-400">toàn diện</span>
            </h2>
            <p className="text-slate-400 max-w-2xl mx-auto">Tích hợp các công cụ tiên tiến nhất để tối ưu hóa quá trình tiếp thu kiến thức của bạn.</p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-10">
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h4 className="text-xl font-bold text-white mb-3">Tốc độ & Hiệu quả</h4>
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h4 className="text-xl font-bold text-white mb-3">Lưu trữ An toàn</h4>
              <p className="text-slate-400 leading-relaxed">
            ...
            <div className="flex flex-col items-center text-center p-6">
              ...
              <h4 className="text-xl font-bold text-white mb-3">Học nhóm dễ dàng</h4>
              <p className="text-slate-400 leading-relaxed">
      ...
      {/* Footer */}
      <footer className="bg-[#05070A] border-t border-white/5 pt-16 pb-8 relative z-10">
